<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="艺术家艺术品名称" prop="gongyipinmingcheng">
          <el-input v-model="ruleForm.gongyipinmingcheng" 
              placeholder="艺术家艺术品名称" clearable  :readonly="ro.gongyipinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="艺术家艺术品名称" prop="gongyipinmingcheng">
              <el-input v-model="ruleForm.gongyipinmingcheng" 
                placeholder="艺术家艺术品名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
